...
[GeneratePropertyBag]
[Condition(
    name: "Is In Defensive Actif Mode",
    story: "Is In Defensive Actif Mode",
    category: "Ally Conditions",
    id: "AllyCondition_IsInDefensiveActifMode_v1"
)]
public partial class IsInDefensiveActiveModeCondition : Unity.Behavior.Condition
{
    private const string BB_IS_IN_DEFENSIVE_MODE = "IsDefending";
    ...
    private void CacheBlackboardVariable()
    {
        ...
        if (agent == null || agent.BlackboardReference == null)
        {
            ...
            if (agent == null || agent.BlackboardReference == null)
            {
                Debug.LogError("[IsInDefensiveActiveModeCondition] BehaviorGraphAgent or Blackboard not found.", GameObject);
                return;
            }
        }
        ...
        {
            Debug.LogWarning($"[IsInDefensiveActiveModeCondition] Blackboard variable '{BB_IS_IN_DEFENSIVE_MODE}' not found.", GameObject);
        }
