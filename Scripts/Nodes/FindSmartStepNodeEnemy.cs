...
[GeneratePropertyBag]
[NodeDescription(
    name: "Find Smart Step (Enemy)",
    story: "Find Smart Step (Enemy)",
    category: "Pathfinding Actions",
    id: "Pathfinding_FindEnemySmartStep_v1" // ID unique pour le noeud ennemi
)]
public partial class FindEnemySmartStepNode : Unity.Behavior.Action
{
